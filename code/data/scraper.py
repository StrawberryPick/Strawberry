...
import time
from collectingFarms import Search
...
# print(results)
searchObject1 = ScrapeReview("farm pick your own list in England")
searchObject1.getFarmsLinks(50)
searchObject1.downloadData(folderPath="./code/data/England/")